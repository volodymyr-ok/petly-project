...
export const ImageCropper = ({ setCroppedImageFor, avatar, small }) => {
  ...
  const getPrevue = async (croppedAreaPixels) => {
    try {
      ...
      setPrevue(true);
      setPrevueUrl(result);
      const croppedImageUrl = await getCroppedImgPrevue(
        image,
  ...
  return (
    <CropBox small={small} id="1">
      <CropImgPrevue id="2">
        {image && !prevue && (
          <Boxik small={small} id="3">
            <CropContainer id="4">
              <Cropper
                image={image}
                crop={crop}
            ...
            <CropControls id="5">
              ...
              <ControlsButtonBox id="6">
                <BtnClose type="button" onClick={getPrevue}>
                  Set image
                </BtnClose>
              </ControlsButtonBox>
            </CropControls>
      ...
      <ControllerBox>
        ...
        />
        {!image && (
          <BtnAdd small={small} type="button" onClick={triggerFileSelectPopup}>
