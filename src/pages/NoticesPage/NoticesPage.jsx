...
import { selectError, selectIsLoading, selectNotice } from "../../redux/notice/notice-selectors";
import { getNotice, getNoticesBySearch, getNoticeById} from "../../redux/notice/notice-operations";
...
const NoticesPage = () => {
  ...
  <Container>
      ...
      <div>
        {isLoading ? <PawsLoader /> : error ? <ResultNotFound /> : <NoticesCategoryList
         notices={notices} 
         isLogined = {isLogined} 
